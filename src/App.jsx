...
function ZapierLogo() {
  return (
    <span aria-label="Zapier" className="font-extrabold text-[22px] leading-none tracking-tight select-none">
      <span style={{ color: '#FF4F00' }}>Z</span>
      <span style={{ color: '#201515' }}>apier</span>
    </span>
  )
}
